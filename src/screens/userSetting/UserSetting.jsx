...
const UserSetting = () => {
  ...
  {[
    ...
    { label: "غلق الحساب" },
    { icon: "bi-box-arrow-right", label: "تسجيل الخروج", isLogout: true },
          ...
          <div className="col-md-9">
            <div className="shadow bg-white rounded p-4 h-100">
              <div className="row g-4 ">
                <h4 className="fw-bold mb-0 text-dark border-bottom py-2 ">نظرة عامة حول الحساب</h4>

                <div className="col-md-6">
                  <div className="border rounded p-3 h-100">
                    <h6 className="fw-bold border-bottom pb-3 mb-3">تفاصيل الحساب</h6>
                    <p className="mb-1">{user?.name || "اسم المستخدم غير متوفر"}</p>
                    <p className="mb-5 text-muted">{user?.email || "البريد الإلكتروني غير متوفر"}</p>
                  </div>
                </div>
                ...
                <div className="col-md-6">
                  <div className="border rounded p-3 h-100">
                    ...
                    <p className="mb-0 text-muted">{user?.name || "اسم المستخدم غير متوفر"}</p>
                    <p className="mb-0 text-muted">{user?.address?.city || "غير متوفر"}</p>
                    <p className="mb-0 text-muted">{user?.address?.governorate || "غير متوفر"}</p>
                    <p className="mb-0 text-muted">{user?.address?.street || "غير متوفر"}</p>
                    <p className="mb-0 text-muted">2{user?.mobilePhone || " غير متوفر"}+</p>
                  </div>
                </div>
                ...
                <div className="col-md-6 ">
                  <div className="border rounded p-3 h-100 ">
                    ...
                    <p className="mb-5 svgg">
                      <svg className='mmsvg' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20" fill="#264996">
                ...
                <div className="col-md-6">
                  <div className="border rounded p-3 h-100">
                    ...
                    <p className="mb-3">قم بإدارة اتصالات بريدك الإلكتروني للبقاء على اطلاع بآخر الأخبار والعروض.</p>
                    <a href="#" className="textWarn text-decoration-none mb-5 fw-bold">تعديل تفضيلات النشرة الإخبارية</a>
                  </div>
                </div>
