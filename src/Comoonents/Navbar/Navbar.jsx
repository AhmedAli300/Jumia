                ...
                <ul className="dropdown-menu custom-dropdown text-end" aria-labelledby="loginDropdown">
                  {!user ? (
                    ...
                    <>
                      ...
                      <li className="logout">
                        <a className="dropdown-item logout" onClick={() => dispatch(logout())} style={{ cursor: 'pointer', color: " #fe9a24;" }}>
                          <i className="bi bi-box-arrow-right mx-1 logout"></i> تسجيل الخروج
                        </a>
                      </li>
                    </>
                  )}
                ...
                <i className="bi bi-cart fs-5 mx-1 position-relative">
                  {cartSize > 0 && (
                    <span className="badge position-absolute top-0 start-100 translate-middle badge rounded-pill "
                      style={{ fontSize: '10px', padding: '4px 5px', backgroundColor: '#fe9a24' }}>
